...
$(document).ready(function() {
	...
	$('#submitted').click(function(){
		...
		endDate = $('#endDate').val();
		dishClass = $('#dishClass').val();
		if(beginDate!="" && endDate!="" && dishClass!=0){
// 			alert("okok!!");
			$.getJSON('chart.do',{"beginDate":beginDate,"endDate":endDate,"dishClass":dishClass,"action":"selectDish"},function(data){
	...
	$(document).on('click','#container g tspan',function(){
		var dishesName = $(this).text();
// 		alert(dishesName);
		$.getJSON("chart.do",{"beginDate":beginDate,"endDate":endDate,"dishesName":dishesName,"action":"selectEachDish"},function(eachdata){
			Highcharts.chart('eachDishes', {
		        chart: {
		            type: 'column'
		        },
		        title: {
